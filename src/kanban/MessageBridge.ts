...
export class MessageBridge {
  ...
  private isWebViewMessage(msg: unknown): msg is WebViewToHost {
    ...
    const validTypes = ['taskMoved', 'openCopilot', 'refreshRequest', 'ready', 'startSquad', 'toggleAutoSquad', 'launchProvider', 'reopenSession', 'openWorktree', 'reviewWorktree', 'mergeWorktree'];
